...
def notifyDiscord(String buildStatus = 'SUCCESS', String lastRunningStage ='PRE-BUILD', TestResultSummary testResult) {
  ...
  if (DISCORD_WEBHOOK_URL) {
    discordSend (description: completeMessage, footer: "${commitMessageDetail}", link: title_link, result: currentBuild.currentResult, title: JOB_NAME, webhookURL: "${DISCORD_WEBHOOK_URL?.trim()}")
  }
}
